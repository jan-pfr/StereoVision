...
size_of_chessboard_squares_mm = 20.75
...
# Show calibrated calibreation Images
pic_left = cv.imread('images/stereoLeft/stereoLeft1.png')
pic_right = cv.imread('images/stereoRight/stereoRight1.png')
pic_right = cv.remap(pic_right, stereoMapR[1], stereoMapR[0], cv.INTER_LANCZOS4, cv.BORDER_CONSTANT, 0)
pic_left = cv.remap(pic_left, stereoMapL[1], stereoMapL[0], cv.INTER_LANCZOS4, cv.BORDER_CONSTANT, 0)
while True:
    cv.imshow("pic_right",pic_right)
    cv.imshow("pic_left",pic_left)
